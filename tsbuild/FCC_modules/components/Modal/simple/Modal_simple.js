...
export default (function (props) { return (React.createElement("div", { className: "modal-simple" },
    React.createElement("div", { className: "modal-inner" },
        ...
        React.createElement("button", { className: "modal-close-btn blake", onClick: function () { props.blake(); } }, "\u3068\u3058\u308B")))); });
